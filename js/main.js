...
const sheduleForm = document.getElementById('sheduleForm'),
	...
	sheduleEmail = document.getElementById('sheduleEmail'),
	shedulePhone = document.getElementById('shedulePhone'),
	sheduleBusStop = document.getElementById('sheduleBusStop'),
	sheduleAddress = document.getElementById('sheduleAddress'),
	sheduleNumberOfItem = document.getElementById('sheduleNumberOfItem'),
	sheduleMessage = document.getElementById('sheduleMessage'),
	// contact
...
if (typeof faqApi !== 'undefined') {
	// get FAQ of customers
	faqApi();
}
if (typeof pricingListApi !== 'undefined') {
